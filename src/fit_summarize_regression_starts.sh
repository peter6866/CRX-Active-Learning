...
sbatch --dependency=afterok:$jid -o $stdout -e $stderr --mail-type=END,FAIL --wrap="python3 src/summarize_regression_starts.py $dirname; python3 src/eval_regression_on_test_sets.py $dirname/best_model/"