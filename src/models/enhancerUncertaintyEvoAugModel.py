...
class EnhancerUncertaintyEvoAugModel(pl.LightningModule):
    def __init__(self, learning_rate, sample_type=None, init_var=1, min_var=1e-8, max_var=100, label=None,
                augment_list=[], max_augs_per_seq=0, hard_aug=True, finetune=False, inference_aug=False):
        super().__init__()
